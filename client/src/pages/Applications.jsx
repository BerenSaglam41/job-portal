...
const Applications = () => {
  ...
  const {backendUrl,userData,userApplications,fetchUserData,fetchUserApplicationsData} = useContext(AppContext)
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            ...
            <>   
              <label className='flex items-center' htmlFor="resumeUpload">
                ...
                <input id='resumeUpload' onChange={(e) => setResume(e.target.files[0])} type="file" accept='applicaton/pdf' hidden/>
