...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* NavBar For Recruit Panel */}
      <div className="shadow py-4">
        <div className="px-5 flex justify-between items-center">
          <img src={assets.logo} alt="" onClick={() => navigate('/')} className="max-sm:w-32 cursor-pointer"/>
          {companyData && (
      ...
      <div className="flex items-start">
        {/* Left Sidebar With Option to add job,manage jobs,view applicaitons */}
